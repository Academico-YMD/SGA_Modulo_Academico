...
import modelo.AsignaturasFacade;
...
public class AsignaturasController implements Serializable {
    ...
    @EJB
    private modelo.AsignaturasFacade ejbFacade;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("AsignaturasDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
